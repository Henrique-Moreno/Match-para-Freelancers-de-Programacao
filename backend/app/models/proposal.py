...
class Proposal(db.Model):
    ...
    project_id = db.Column(db.Integer, db.ForeignKey('project.id'), nullable=False)  # Chave estrangeira para o projeto
    freelancer_id = db.Column(db.Integer, db.ForeignKey('freelancer.id'), nullable=False)  # Chave estrangeira para o freelancer
    ...
    freelancer = db.relationship('Freelancer', backref=db.backref('proposals', lazy=True))
